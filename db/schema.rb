...
ActiveRecord::Schema.define(version: 20151102061921) do
  ...
  add_index "admins", ["mobile", "email"], name: "index_admins_on_account", unique: true, using: :btree
  add_index "admins", ["mobile"], name: "index_admins_on_mobile", using: :btree
  ...
  add_index "enterprises", ["email"], name: "index_enterprises_on_email", using: :btree
  add_index "enterprises", ["mobile", "email"], name: "index_enterprises_on_account", unique: true, using: :btree
  add_index "enterprises", ["mobile"], name: "index_enterprises_on_mobile", using: :btree
